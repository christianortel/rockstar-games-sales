...
- It combines product design, frontend engineering, and analytics architecture in one coherent build.
- It treats uncertainty as a first-class UX problem instead of hiding it.
- It shows practical data modeling, not just chart wiring.
- It demonstrates system design through repository, presenter, theme, and asset layers.
- It includes a raw SQL inspection surface, which makes the project stronger technically than a presentation-only dashboard.
- It is distinctive enough to be memorable while still being technically defensible.
